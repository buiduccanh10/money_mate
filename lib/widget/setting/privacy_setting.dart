          ...
          body: SingleChildScrollView(
            child: Column(children: [
              _buildPrivacyItem(
                ...
                label: LocaleData.delete_all_data_acc.getString(context),
                subLabel: LocaleData.delete_all_data_acc_des.getString(context),
              ...
              _buildPrivacyItem(
                ...
                label: LocaleData.delete_acc.getString(context),
                subLabel: LocaleData.delete_acc_des.getString(context),
                onTap: () => _confirmDelete(
                  context,
