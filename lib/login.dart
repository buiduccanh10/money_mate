  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        ...
        child: Padding(
          padding: const EdgeInsets.only(top: 130.0, left: 14, right: 14),
          child: Column(
            children: [
              SizedBox(
                  height: 250,
                  child: RiveAnimation.asset(
                    ...
                    onInit: (artboard) {
                      state_controller = StateMachineController.fromArtboard(
                        ...
                        InkWell(
                          onTap: () {
                            if (email_controller.text == admin_email &&
                                password_controller.text == admin_password) {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              // Using rive prefix to specify which LinearGradient to use
                              borderRadius: BorderRadius.circular(10),
                            ),
                            height: 50,
                            width: 380,
